    ...
    <div style="min-height: 70vh; display: flex; align-items: center; justify-content: center; padding: 80px 20px;">
        <div style="text-align: center; max-width: 600px;">
            ...
            <h1 style="font-size: 3.5rem; color: var(--primary); margin-bottom: 30px; font-weight: 300; font-family: 'Cormorant Garamond', serif; line-height: 1.2;">
                Une Erreur s'est <span style="font-style: italic;">Produite.</span>
            </h1>

            <p style="color: var(--text-dim); font-size: 1.1rem; line-height: 1.9; margin-bottom: 20px; font-family: 'Jost', sans-serif; max-width: 460px; margin-left: auto; margin-right: auto;">
                Nos équipes ont été notifiées. Veuillez patienter quelques instants et réessayer. Si le problème persiste, contactez l'administrateur.
            </p>

            <div style="font-family: 'Cormorant Garamond', serif; font-size: 8rem; color: var(--primary); opacity: 0.06; line-height: 1; font-weight: 700; margin: 20px 0 40px; user-select: none; pointer-events: none; letter-spacing: -0.02em;">
                500
            </div>
            ...
            <div style="display: flex; gap: 20px; justify-content: center; flex-wrap: wrap;">
                ...
                <button onclick="window.location.reload()"
                    style="padding: 18px 45px; border: 1px solid var(--primary); color: var(--primary); background: none; font-size: 0.75rem; font-weight: 700; letter-spacing: 0.25em; text-transform: uppercase; cursor: pointer; transition: all 0.4s; border-radius: 3px; font-family: 'Jost', sans-serif;"
