    ...
    <div style="max-width: 700px; margin: 60px auto; padding: 0 20px;">
        <div class="card"
            ...
            <div style="text-align: center; margin-bottom: 60px;">
                <div
                    style="font-family: 'Cormorant Garamond', serif; font-size: clamp(1.4rem, 7vw, 2.8rem); color: var(--primary); letter-spacing: 0.02em; margin-bottom: 16px; font-weight: 300; line-height: 1.2;">
            ...
            <form method="POST" action="{{ route('register') }}" style="display: flex; flex-direction: column; gap: 35px;">
                ...
                <div style="margin-top: 20px;">
                    <button type="submit" class="btn"
                        ...
                        onmouseout="this.style.background='var(--primary)'; this.style.transform='translateY(0)';">CRÉER MON
                        ACCÈS</button>
                </div>
            </form>
